...
<body>
				...
				<div class="col-md-6">
					<form action="IMCServlet" method="POST">
						...
						<div class="text-center">
							<!--  esto es pilleria para centrar el boton -->
							<input type="submit" value="Calcular" class="btn btn-success"
								id="calcular" />

							<div class="form-group">
								<label for="calcular">IMC</label> <input type="text"
									class="form-control" id="imc" disabled name="imc"
									value=<%
											//recuperar valor de una variable y esa variable va a ser una variable de tipo Session.
	...
	out.println(request.getSession().getAttribute("imc"));
						...
						<div class="form-group">
							<label for="cacular">Leer</label> <input type="text"
								class="form-control" id="lectura" disabled name="lectura"
								value=<%
